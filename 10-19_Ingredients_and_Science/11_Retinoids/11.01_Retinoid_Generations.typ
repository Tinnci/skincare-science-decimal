...
Synthetic retinoids where the polar end group is replaced by an aromatic ring.
- *Etretinate & Acitretin:* Primarily used for psoriasis.
...
== Historical Context: The Cosmetic vs. Drug Divide

The distinction between cosmetic retinol and prescription retinoids is often a "historical accident":
- *Origins:* Retinol was already used in cosmetics for antioxidant properties before its role as a *prodrug of retinoic acid* (Tretinoin) was fully understood (Kang & Voorhees).
- *Regulation:* Because it was already in the market at lower concentrations, the FDA maintained its status as a cosmetic rather than reclassifying it as a drug.
- *Prodrug Path:* 
  $ "Retinol" -> "Retinaldehyde" -> "Retinoic Acid (Tretinoin)" $
  Retinol must be converted in the skin to exert its biological effects through Retinoic Acid Receptors.
